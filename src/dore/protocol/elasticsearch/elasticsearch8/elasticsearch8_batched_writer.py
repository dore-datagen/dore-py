...
from dore.protocol.elasticsearch.config.elasticsearch_model_properties_config \
    import ElasticSearchModelPropertiesConfig
...
class ElasticSearch8BatchedWriter(BatchedWriter):
    ...
    def __init__(self, datastore: ElasticSearch8Datastore, model: Model):
