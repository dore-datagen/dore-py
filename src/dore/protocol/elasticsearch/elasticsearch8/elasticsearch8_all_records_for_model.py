...
"""
Get all records for model :: elasticsearch8
"""
...
from dore.protocol.elasticsearch.elasticsearch8.elasticsearch8_doc_to_record_mapper_factory \
    import elasticsearch8_doc_to_record_mapper_factory

def elasticsearch8_all_records_for_model(datastore: ElasticSearch8Datastore, model: Model):
    client = datastore.client()
    index_name = model.config().properties(ElasticSearchModelPropertiesConfig).index_name()

    response_mapper = elasticsearch8_doc_to_record_mapper_factory(model)
